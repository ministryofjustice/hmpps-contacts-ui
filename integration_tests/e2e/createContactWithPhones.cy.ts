...
context('Create Contact With Phone Numbers', () => {
  ...
  it('Can create a contact with some phone numbers', () => {
    ...
    Page.verifyOnPage(CreateContactCheckYourAnswersPage) //
      ...
      .clickLinkTo('Back', CreateContactCheckYourAnswersPage)
    ...
    Page.verifyOnPage(CreateContactCheckYourAnswersPage) //
      ...
      .clickButtonTo('No, do not delete', CreateContactCheckYourAnswersPage)
      ...
      .clickButtonTo('Yes, delete', CreateContactCheckYourAnswersPage)
