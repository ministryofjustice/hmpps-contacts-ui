...
export default class CreateContactAddressesPage extends Page {
  ...
  clickDeleteAddressLinkTo<T>(index: number, constructor: new (...args: any) => T, ...args: any): T {
  ...
  clickChangeTypeLinkTo<T>(index: number, constructor: new (...args: any) => T, ...args: any): T {
  ...
  clickChangeAddressLinkTo<T>(index: number, constructor: new (...args: any) => T, ...args: any): T {
  ...
  clickChangeDatesLinkTo<T>(index: number, constructor: new (...args: any) => T, ...args: any): T {
  ...
  clickChangeFlagsLinkTo<T>(index: number, constructor: new (...args: any) => T, ...args: any): T {
  ...
  clickChangeCommentsLinkTo<T>(index: number, constructor: new (...args: any) => T, ...args: any): T {
  ...
  clickAddAddressPhoneLinkTo<T>(constructor: new (...args: any) => T, ...args: any): T {
    cy.findByRole('link', {
  ...
  clickChangeAddressPhoneLinkTo<T>(index: number, constructor: new (...args: any) => T, ...args: any): T {
  ...
  clickDeleteAddressPhoneLinkTo<T>(index: number, constructor: new (...args: any) => T, ...args: any): T {
