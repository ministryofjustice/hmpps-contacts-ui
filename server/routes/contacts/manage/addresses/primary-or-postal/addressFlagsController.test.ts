...
describe('GET /prisoner/:prisonerNumber/contacts/manage/:contactId/relationship/:prisonerContactId/address/primary-or-postal/:journeyId', () => {
  it('should render address primary or postal page', async () => {
    ...
    expect($('title').text()).toStrictEqual(
      'Set an address as the primary or postal address for the contact - Edit contact methods - DPS',
    )
  ...
  it('should render not found no journey in session', async () => {
    await request(app)
      .get(
        `/prisoner/${prisonerNumber}/contacts/manage/${contactId}/relationship/${prisonerContactId}/address/primary-or-postal/${randomUUID()}`,
      )
      .expect(404)
      .expect(res => {
