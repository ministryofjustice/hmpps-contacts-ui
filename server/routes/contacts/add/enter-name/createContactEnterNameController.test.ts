...
describe('GET /prisoner/:prisonerNumber/contacts/create/enter-name', () => {
  it('should render enter name page', async () => {
    ...
    expect(warningText).toContain(
      'As a Contacts Administrator, you cannot approve this contact to visit John Smith. If you need to do this, ask for the Contacts Authoriser',
    )
  ...
  it('should return to start if no journey in session', async () => {
    await request(app)
      .get(`/prisoner/${prisonerNumber}/contacts/create/enter-name/${randomUUID()}`)
      .expect(302)
...
describe('POST /prisoner/:prisonerNumber/contacts/create/enter-name/:journeyId', () => {
  ...
  it('should return to start if no journey in session', async () => {
    await request(app)
      .post(`/prisoner/${prisonerNumber}/contacts/create/enter-name/${randomUUID()}`)
      .type('form')
      .send({ firstName: 'first' })
      .expect(302)
      .expect('Location', `/prisoner/${prisonerNumber}/contacts/create/start`)
