...
describe('GET /prisoner/:prisonerNumber/contacts/create/enter-dob/:journeyId', () => {
  ...
  it('should return to start if no journey in session', async () => {
    await request(app)
      .get(`/prisoner/${prisonerNumber}/contacts/create/enter-dob/${randomUUID()}`)
      .expect(302)
  ...
  it('GET should block access without edit contacts permission', async () => {
    ...
    await request(app).get(`/prisoner/${prisonerNumber}/contacts/create/enter-dob/${journeyId}`).expect(403)
  })
})
...
describe('POST /prisoner/:prisonerNumber/contacts/create/enter-name', () => {
  ...
  it('should return to start if no journey in session', async () => {
    await request(app)
      .post(`/prisoner/${prisonerNumber}/contacts/create/enter-dob/${randomUUID()}`)
      .type('form')
      .send({})
      .expect(302)
      .expect('Location', `/prisoner/${prisonerNumber}/contacts/create/start`)
