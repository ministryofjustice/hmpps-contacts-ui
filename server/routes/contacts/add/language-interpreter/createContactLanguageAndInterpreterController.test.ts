...
describe('GET /prisoner/:prisonerNumber/contacts/create/language-and-interpreter/:journeyId', () => {
  ...
  it('should return to start if no journey in session', async () => {
    await request(app)
      .get(`/prisoner/${prisonerNumber}/contacts/create/language-and-interpreter/${randomUUID()}`)
      .expect(302)
...
describe('POST /prisoner/:prisonerNumber/contacts/create/language-and-interpreter/:journeyId', () => {
  ...
  it('should return to start if no journey in session', async () => {
    await request(app)
      .post(`/prisoner/${prisonerNumber}/contacts/create/language-and-interpreter/${randomUUID()}`)
      .type('form')
      .send({})
      .expect(302)
      .expect('Location', `/prisoner/${prisonerNumber}/contacts/create/start`)
