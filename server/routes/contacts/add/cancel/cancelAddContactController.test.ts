...
describe('GET /prisoner/:prisonerNumber/contacts/add/cancel/:journeyId', () => {
  ...
  it('should return to start if no journey in session', async () => {
    await request(app)
      .get(`/prisoner/${prisonerNumber}/contacts/add/cancel/${randomUUID()}`)
      .expect(302)
  ...
  it('GET should block access without edit contacts permission', async () => {
    ...
    await request(app).get(`/prisoner/${prisonerNumber}/contacts/add/cancel/${journeyId}`).expect(403)
  })
})
...
describe('POST /prisoner/:prisonerNumber/contacts/add/cancel/:journeyId', () => {
  ...
  it('should return to start if no journey in session', async () => {
    await request(app)
      .post(`/prisoner/${prisonerNumber}/contacts/add/cancel/${randomUUID()}`)
      .type('form')
      .expect(302)
      .expect('Location', `/prisoner/${prisonerNumber}/contacts/create/start`)
  })
