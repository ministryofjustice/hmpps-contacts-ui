...
beforeEach(() => {
  ...
  app = appWithAllRoutes({
    ...
    sessionReceiver: (receivedSession: Partial<SessionData>) => {
      ...
      // changed to use searchContactJourneys (used by ContactViewController)
      session.searchContactJourneys = {}
      session.searchContactJourneys![journeyId] = existingJourney
    },
  })
  ...
  describe('Contact methods tab', () => {
    ...
    describe('Emails summary card', () => {
      it('should render all emails', async () => {
        ...
        // note the partial may order addresses; tests expect the displayed ones
    ...
    describe('Global Restrictions', () => {
      describe('GET /contacts/view/:matchingContactId/:journeyId#restrictions', () => {
        it('should render restrictions tab', async () => {
          ...
          expect($('caption.restrictions-caption-CONTACT_GLOBAL').text().trim()).toStrictEqual(
