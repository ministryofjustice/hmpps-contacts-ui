...
export enum Page {
  ...
  ADD_CONTACT_EDIT_IDENTITY_PAGE = 'ADD_CONTACT_EDIT_IDENTITY_PAGE',
  ADD_CONTACT_DELETE_IDENTITY_PAGE = 'ADD_CONTACT_DELETE_IDENTITY_PAGE',
  ADD_CONTACT_ADD_EMAIL_PAGE = 'ADD_CONTACT_ADD_EMAIL_PAGE',
  ADD_CONTACT_DELETE_EMAIL_PAGE = 'ADD_CONTACT_DELETE_EMAIL_PAGE',
  ...
  ADD_CONTACT_APPROVED_TO_VISIT_PAGE = 'ADD_CONTACT_APPROVED_TO_VISIT_PAGE',
  ADD_CONTACT_HANDLE_DUPLICATE_PAGE = 'ADD_CONTACT_HANDLE_DUPLICATE_PAGE',
  ADD_CONTACT_POSSIBLE_EXISTING_RECORDS_PAGE = 'ADD_CONTACT_POSSIBLE_EXISTING_RECORDS_PAGE',
  ADD_CONTACT_POSSIBLE_EXISTING_RECORD_MATCH_PAGE = 'ADD_CONTACT_POSSIBLE_EXISTING_RECORD_MATCH_PAGE',
  ADD_CONTACT_REVIEW_EXISTING_RELATIONSHIPS_PAGE = 'ADD_CONTACT_REVIEW_EXISTING_RELATIONSHIPS_PAGE',
  ADD_CONTACT_POSSIBLE_DUPLICATE_EXISTING_RELATIONSHIPS_PAGE = 'ADD_CONTACT_POSSIBLE_DUPLICATE_EXISTING_RELATIONSHIPS_PAGE',
  // Common contact pages
  SELECT_CONTACT_RELATIONSHIP = 'SELECT_CONTACT_RELATIONSHIP',
  SELECT_EMERGENCY_CONTACT_OR_NEXT_OF_KIN = 'SELECT_EMERGENCY_CONTACT_OR_NEXT_OF_KIN',
  SELECT_RELATIONSHIP_TYPE = 'SELECT_RELATIONSHIP_TYPE',
  ENTER_RELATIONSHIP_COMMENTS = 'ENTER_RELATIONSHIP_COMMENTS',
  ADD_ADDRESSES = 'ADD_ADDRESSES',
  ADD_EMPLOYMENTS = 'ADD_EMPLOYMENTS',
  ...
  // Search for a contact directly without going through a prisoner
  CONTACT_SEARCH_START_PAGE = 'CONTACT_SEARCH_START_PAGE',
  DIRECT_CONTACT_SEARCH_PAGE = 'DIRECT_CONTACT_SEARCH_PAGE',
  DIRECT_CONTACT_VIEW_PAGE = 'DIRECT_CONTACT_VIEW_PAGE',
  CONTACT_MATCH_PAGE = 'CONTACT_MATCH_PAGE',
  ...
  EDIT_CONTACT_DETAILS_CONFIRM_PAGE = 'EDIT_CONTACT_DETAILS_CONFIRM_PAGE',
  EDIT_RESTRICTIONS_PAGE = 'EDIT_RESTRICTIONS_PAGE',
  ...
  MANAGE_CONTACT_DELETE_RELATIONSHIP = 'MANAGE_CONTACT_DELETE_RELATIONSHIP',
  ...
  MANAGE_CONTACT_START_MANAGE_EMPLOYMENT_PAGE = 'MANAGE_CONTACT_START_MANAGE_EMPLOYMENT_PAGE',
  LIST_CONTACTS_PAGE = 'LIST_CONTACTS_PAGE',
  UPDATE_CONTACT_DOB_ENTER_DOB_PAGE = 'UPDATE_CONTACT_DOB_ENTER_DOB_PAGE',
  UPDATE_CONTACT_DOB_DELETE_DOB_PAGE = 'UPDATE_CONTACT_DOB_DELETE_DOB_PAGE',
  ...
  VIEW_RESTRICTION_PAGE = 'VIEW_RESTRICTION_PAGE',
  ...
  // Create Contact - Employment
  CREATE_CONTACT_SEARCH_ORGANISATION_PAGE = 'CREATE_CONTACT_SEARCH_ORGANISATION_PAGE',
  CREATE_CONTACT_CHECK_EMPLOYER_PAGE = 'CREATE_CONTACT_CHECK_EMPLOYER_PAGE',
  CREATE_CONTACT_EMPLOYMENT_STATUS_PAGE = 'CREATE_CONTACT_EMPLOYMENT_STATUS_PAGE',
  CREATE_CONTACT_DELETE_EMPLOYMENT_PAGE = 'CREATE_CONTACT_DELETE_EMPLOYMENT_PAGE',
  // Relationship type
  ...
  CHANGE_RELATIONSHIP_HANDLE_DUPLICATE_PAGE = 'CHANGE_RELATIONSHIP_HANDLE_DUPLICATE_PAGE',
}
