...
describe('Prisoner search service', () => {
  ...
  beforeEach(() => {
    ...
    prisonerSearchClient = new PrisonerSearchClient(token) as jest.Mocked<PrisonerSearchClient>
  ...
  xdescribe('getPrisonerNotFoundMessage', () => {
