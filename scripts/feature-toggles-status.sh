...
FEATURE_CHANGE_CONTACT_NAME_ENABLE_DATE=$(kubectl -n "$CONTACTS_UI_NAMESPACE" get secret feature-toggles -o jsonpath='{.data.FEATURE_CHANGE_CONTACT_NAME_ENABLE_DATE}' | base64 -d)
FEATURE_ENHANCED_CONTACT_SEARCH=$(kubectl -n "$CONTACTS_UI_NAMESPACE" get secret feature-toggles -o jsonpath='{.data.FEATURE_ENHANCED_CONTACT_SEARCH}' | base64 -d)
...
echo Contacts ui - FEATURE_CHANGE_CONTACT_NAME_ENABLE_DATE="$FEATURE_CHANGE_CONTACT_NAME_ENABLE_DATE"
echo Contacts ui - FEATURE_ENHANCED_CONTACT_SEARCH="$FEATURE_ENHANCED_CONTACT_SEARCH"